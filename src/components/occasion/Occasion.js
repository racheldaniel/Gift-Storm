...
export default class Occasion extends Component {
  state = {
   ...
   //this function will get friend occasions for this specific user occasion with friend details expanded
   getFriendOccasions = (currentUser) => {
    ...
    return API.getData(`friend_occasions?userId=${currentUser}&user_occasionId=${userOcc.id}&_expand=friend`)
